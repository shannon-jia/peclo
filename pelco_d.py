...
class PelcoD(object):
    ...
    def __init__(self, address, pan_speed=0x40, tilt_speed=0x40):
        self._address = int(address)
        self._word = [0, 0, 0, 0]
        self._pan_speed = int(hex(pan_speed), 16)
        self._tilt_speed = int(hex(tilt_speed), 16)
...
if __name__ == "__main__":
    ...
    pelco = PelcoD(244, 64, 64)
    pelco.down()
    # pelco.right()
    log.info(pelco.hex(' 0x'))
